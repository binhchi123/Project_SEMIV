...
class SearchResultsPage extends StatefulWidget {
  final String name;
  SearchResultsPage({required this.name});
  @override
      ...
      body: SingleChildScrollView(
              ...
              child: Container(
                child: Column(
                  children: [
                    Center(
                      child: Text('Kết quả tìm kiếm cho "${widget.name}"',
                        style: TextStyle(
                          color: Colors.black,
                          fontWeight: FontWeight.bold,
                          fontSize: 22
                    ...
                    SizedBox(height: 25,),
                    FutureBuilder(
                      future: ProductService().searchProducts(widget.name),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState == ConnectionState.waiting) {
                          ...
                          return LayoutBuilder(
                            builder: (context, constraints) {
                              return GridView.builder(
                                ...
                                itemCount: data.length, // Số lượng sản phẩm
                                itemBuilder: (context, index) {
