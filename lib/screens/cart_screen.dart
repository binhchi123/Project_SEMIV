...
class _CartPageState extends State<CartPage> {
  ...
  void _deleteSelectedItems() async {
   ...
   // lấy sản phẩm để checkout
// Future<void> _placeOrder() async {
//   List<dynamic> selectedItems = []; // Danh sách sản phẩm đã chọn

//   // Lấy danh sách sản phẩm đã chọn từ _cartItems
//   for (var item in _cartItems) {
//     if (item['isChecked'] == true) { // Kiểm tra sản phẩm có được chọn không
...
//     try {
//       // Chuyển đến trang Checkout và truyền danh sách sản phẩm đã chọn
//       Navigator.of(context).pushReplacement(
//         MaterialPageRoute(builder: (context) => CheckoutPage(cartItems: selectedItems)),
//       );
//     } catch (e) {
//       ScaffoldMessenger.of(context).showSnackBar(
...
//   } else {
//     ScaffoldMessenger.of(context).showSnackBar(
//       SnackBar(content: Text('Vui lòng chọn ít nhất một sản phẩm để đặt hàng.')),
//     );
//   }
// }
